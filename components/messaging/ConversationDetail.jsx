...
export default function ConversationDetail({
  conversation, messages, loading, msgInput, setMsgInput,
  onSend, sending, onBack, t,
}) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: 'calc(100vh - 200px)', minHeight: '400px' }}>
      ...
      <div style={{
        ...
        padding: '14px 16px', background: 'white', borderRadius: '12px 12px 0 0',
        ...
        <div style={{
          ...
          fontSize: '16px', color: '#6366f1', fontWeight: 700,
        }}>
          {(conversation.employer_name || '?')[0].toUpperCase()}
        </div>
        <span style={{ fontSize: '15px', fontWeight: 700, color: '#1a1a1a' }}>
          {conversation.employer_name || 'Family'}
        </span>
      </div>
