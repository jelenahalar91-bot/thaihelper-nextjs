...
const COPY = {
  ...
  ru: {
    ...
    label: 'Получайте мгновенное уведомление на телефон, когда приходит новое сообщение',
    hint: 'Лучше всего работает на Android (Chrome). На iPhone сначала добавьте ThaiHelper на главный экран.',
    unsupported: 'Ваш браузер не поддерживает push-уведомления. Попробуйте Chrome или Firefox.',
    blocked: 'Уведомления заблокированы. Откройте настройки браузера для этого сайта и разрешите уведомления.',
    enable: 'Включить push-уведомления',
    enabling: 'Включаем…',
    enabled: '✓ Включено на этом устройстве',
