...
const T = {
  en: {
    ...
    // Feature lists
    free_feat1: 'Browse all email-verified helper profiles',
    free_feat2: 'See full experience, skills and languages',
  ...
  th: {
    ...
    free_feat1: 'ค้นหาโปรไฟล์ผู้ช่วยที่ยืนยันอีเมลทั้งหมด',
    free_feat2: 'ดูประสบการณ์ ทักษะ และภาษาเต็มรูปแบบ',
