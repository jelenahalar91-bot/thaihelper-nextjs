...
const T = {
  en: {
    ...
    tier_3m_price: '699',
    tier_3m_per_equiv: '≈ 233 THB/month',
    tier_3m_save: 'Save 22%',
    ...
    tier_12m_price: '1,990',
    tier_12m_per_equiv: '≈ 166 THB/month',
    tier_12m_save: 'Save 45%',
    ...
    faq_a1: 'No. You can register as an employer and browse all helpers for free — no credit card required. During our launch phase, new accounts also get 8 weeks of full access on the house. This launch bonus will go away once we\'ve grown our network of helpers and employers, so the earlier you join, the better.',
  ...
  th: {
    ...
    tier_3m_price: '699',
    tier_3m_per_equiv: '≈ 233 บาท/เดือน',
    tier_3m_save: 'ประหยัด 22%',
    ...
    tier_12m_price: '1,990',
    tier_12m_per_equiv: '≈ 166 บาท/เดือน',
    tier_12m_save: 'ประหยัด 45%',
    ...
    faq_a1: 'ไม่ต้อง คุณสามารถลงทะเบียนเป็นนายจ้างและค้นหาผู้ช่วยได้ฟรี ไม่ต้องใช้บัตรเครดิต ในช่วงเปิดตัว บัญชีใหม่ยังได้รับการเข้าถึงเต็มรูปแบบฟรี 8 สัปดาห์ โบนัสนี้จะหายไปเมื่อเครือข่ายผู้ช่วยและนายจ้างของเราเติบโตขึ้น ยิ่งสมัครเร็ว ยิ่งได้ประโยชน์',
  ...
  ru: {
    ...
    tier_3m_price: '699',
    tier_3m_per_equiv: '≈ 233 THB/мес',
    tier_3m_save: 'Экономия 22%',
    ...
    tier_12m_price: '1,990',
    tier_12m_per_equiv: '≈ 166 THB/мес',
    tier_12m_save: 'Экономия 45%',
    ...
    faq_a1: 'Нет. Вы можете зарегистрироваться как работодатель и просматривать всех помощников бесплатно — карта не нужна. В период запуска новые аккаунты также получают 8 недель полного доступа бесплатно. Этот бонус исчезнет, как только мы вырастим нашу сеть помощников и работодателей — чем раньше вы присоединитесь, тем лучше.',
    ...
    footer_disclaimer: 'ThaiHelper.app — платформа для связи, управляемая Jelena Hermann (Planet Bamboo GmbH), зарегистрированная в Германии. Мы не являемся кадровым агентством и не занимаемся трудоустройством. Платформа в настоящее время полностью бесплатна. Все договорённости являются частными соглашениями между пользователями. Соблюдение трудового и иммиграционного законодательства Таиланда является исключительной ответственностью пользователей.',
  },
};
