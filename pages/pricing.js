...
const T = {
  en: {
    ...
    promo_badge: '🎉 100% free during launch — no credit card required.',
    ...
    faq_a1: 'No. ThaiHelper is currently 100% free for everyone — including messaging helpers — while we are in launch phase. No credit card required. In the future, we will introduce a one-time access fee for messaging, but for now everything on the platform is free to use.',
  ...
  th: {
    ...
    faq_a1: 'ไม่ต้อง ThaiHelper ใช้งานฟรี 100% ในขณะนี้ รวมถึงการส่งข้อความหาผู้ช่วย ในช่วงเปิดตัว ไม่ต้องใช้บัตรเครดิต ในอนาคตเราจะเก็บค่าธรรมเนียมแบบจ่ายครั้งเดียวสำหรับการส่งข้อความ แต่ตอนนี้ทุกอย่างฟรีหมด',
  ...
  ru: {
    ...
    promo_badge: '🎉 100% бесплатно в период запуска — карта не нужна.',
    ...
    faq_a1: 'Нет. ThaiHelper сейчас 100% бесплатен для всех — включая переписку с помощниками — пока мы в период запуска. Карта не нужна. В будущем мы введём разовую плату за доступ к мессенджеру, но сейчас всё на платформе бесплатно.',
