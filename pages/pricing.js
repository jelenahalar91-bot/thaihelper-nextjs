...
const T = {
  en: {
    ...
    promo_badge: '🎉 New employers get the first 4 weeks free — no credit card required.',
    ...
    faq_a1: 'No. You can register as an employer and browse all helpers for free — no credit card required. During our launch phase, new accounts also get 4 weeks of full access on the house. This launch bonus will go away once we\'ve grown our network of helpers and employers, so the earlier you join, the better.',
  ...
  th: {
    ...
    promo_badge: '🎉 นายจ้างใหม่ได้ใช้งานเต็มรูปแบบฟรี 4 สัปดาห์ — ไม่ต้องใช้บัตรเครดิต',
    ...
    faq_a1: 'ไม่ต้อง คุณสามารถลงทะเบียนเป็นนายจ้างและค้นหาผู้ช่วยได้ฟรี ไม่ต้องใช้บัตรเครดิต ในช่วงเปิดตัว บัญชีใหม่ยังได้รับการเข้าถึงเต็มรูปแบบฟรี 4 สัปดาห์ โบนัสนี้จะหายไปเมื่อเครือข่ายผู้ช่วยและนายจ้างของเราเติบโตขึ้น ยิ่งสมัครเร็ว ยิ่งได้ประโยชน์',
  ...
  ru: {
    ...
    promo_badge: '🎉 Новые работодатели получают первые 4 недели бесплатно — карта не нужна.',
    ...
    faq_a1: 'Нет. Вы можете зарегистрироваться как работодатель и просматривать всех помощников бесплатно — карта не нужна. В период запуска новые аккаунты также получают 4 недели полного доступа бесплатно. Этот бонус исчезнет, как только мы вырастим нашу сеть помощников и работодателей — чем раньше вы присоединитесь, тем лучше.',
