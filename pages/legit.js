...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'No. The "Thai Helper" app on the Apple App Store (id1523988930) and Google Play is a phrase-book and pronunciation tool for learning the Thai language — a completely different product run by a different company. ThaiHelper.app (this site) is a hiring marketplace for household staff in Thailand. Our own official app is called "ThaiHelper App", published by Jelena Hermann — on the App Store (id6801794164) and on Google Play (app.thaihelper.mobile). Those two are the only mobile apps operated by us.',
  },
  {
...
const T = {
  en: {
    ...
    confusion1_p: 'The "Thai Helper" iOS / Android app (App Store id1523988930) is a phrase-book and pronunciation tool for learning the Thai language. Different product, different company. Our official app is "ThaiHelper App" — App Store id6801794164, Google Play app.thaihelper.mobile. See the download links above.',
    ...
    app_title: 'Our official mobile apps',
    app_p: 'ThaiHelper App, published by Jelena Hermann — on the App Store (app id 6801794164) and Google Play (app.thaihelper.mobile). These are the only mobile apps we operate. Both are free and show the same helper profiles as this website.',
  ...
  th: {
    ...
    confusion1_p: 'แอป "Thai Helper" บน iOS / Android (App Store id1523988930) เป็นเครื่องมือเรียนคำศัพท์และการออกเสียงภาษาไทย ผลิตภัณฑ์คนละแบบ บริษัทคนละบริษัท แอปอย่างเป็นทางการของเราชื่อ "ThaiHelper App" — App Store id6801794164 และ Google Play app.thaihelper.mobile ดูลิงก์ดาวน์โหลดด้านบน',
    ...
    app_title: 'แอปมือถืออย่างเป็นทางการของเรา',
    app_p: 'ThaiHelper App เผยแพร่โดย Jelena Hermann — บน App Store (app id 6801794164) และ Google Play (app.thaihelper.mobile) นี่คือแอปมือถือเดียวที่เราดูแล ใช้งานฟรีทั้งคู่ และแสดงโปรไฟล์ผู้ช่วยชุดเดียวกับเว็บไซต์นี้',
        ...
        <main className="pt-24 md:pt-28">
          ...
          <section className="px-6 py-12 bg-white border-y border-slate-200">
            <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left">
              ...
              <AppBadges lang={lang} className="shrink-0" />
            </div>
          </section>
