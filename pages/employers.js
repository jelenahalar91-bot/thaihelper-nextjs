...
const T = {
  en: {
    ...
    why4_p: 'Nannies, housekeepers, chefs, drivers, gardeners, elder care, tutors, pet sitters — find everyone you need.',
  ...
  th: {
    ...
    why4_p: 'พี่เลี้ยง แม่บ้าน พ่อครัว คนขับ คนสวน ดูแลผู้สูงอายุ ติวเตอร์ ผู้ดูแลสัตว์เลี้ยง — หาทุกอย่างที่ต้องการ',
