...
const T = {
  en: {
    ...
    how3_p: 'Chat with helpers right on the platform. 100% free for the first 2 months — no credit card required.',
    // Why
    ...
    promo_badge: '100% free for the first 2 months — no credit card',
    cta_card_h: 'Create Your Free Account',
    cta_card_sub: 'Free account with full messaging access for your first 2 months. Find the perfect helper for your family.',
  ...
  th: {
    ...
    how3_p: 'แชทกับผู้ช่วยบนแพลตฟอร์มได้เลย ฟรี 100% สำหรับ 2 เดือนแรก ไม่ต้องใช้บัตรเครดิต',
    ...
    cta_card_sub: 'บัญชีฟรีพร้อมสิทธิ์ส่งข้อความเต็มรูปแบบใน 2 เดือนแรก หาผู้ช่วยที่ใช่สำหรับครอบครัวของคุณ',
  ...
  ru: {
    ...
    how3_p: 'Общайтесь с помощниками прямо на платформе. 100% бесплатно первые 2 месяца — без карты.',
    ...
    promo_badge: '100% бесплатно первые 2 месяца — без карты',
    cta_card_h: 'Создайте бесплатный аккаунт',
    cta_card_sub: 'Бесплатный аккаунт с полным доступом к сообщениям первые 2 месяца. Найдите идеального помощника для вашей семьи.',
