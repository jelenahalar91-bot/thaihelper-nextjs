...
const T = {
  en: {
    ...
    family_title: ‘I’m looking to hire’,
    family_desc: ‘Families, individuals & business — find trusted household help.’,
    helper_title: ‘I’m a helper’,
    helper_desc: ‘I’m looking for work.’,
    cta: ‘Continue’,
  ...
  th: {
    ...
    family_title: ‘ฉันต้องการจ้างผู้ช่วย’,
    family_desc: ‘ครอบครัว บุคคล และธุรกิจ — หาความช่วยเหลือที่เชื่อถือได้’,
