...
const T = {
  en: {
    ...
    promo_badge: '🎉 Free for the first 8 weeks',
    promo_text: 'Sign up now and get full messaging access for 56 days — no credit card required.',
  ...
  th: {
    ...
    promo_badge: '🎉 ฟรี 8 สัปดาห์แรก',
    promo_text: 'ลงทะเบียนตอนนี้และรับสิทธิ์ส่งข้อความฟรี 56 วัน — ไม่ต้องใช้บัตรเครดิต',
