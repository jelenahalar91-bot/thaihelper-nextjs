...
const T = {
  en: {
    ...
    hero_status_free: 'FREE',
    hero_unread: 'unread',
    launch_banner_title: 'Free for everyone',
    launch_banner_text: 'ThaiHelper is 100% free for both families and helpers. Enjoy full access — including unlimited messaging — at no cost.',
    logout: 'Log Out',
    ...
    msg_offplatform_title: 'You are about to leave ThaiHelper',
    msg_offplatform_body: 'We cannot see or check what happens outside the app, and this is how scams start. Please keep job offers and job requests here in the chat.',
    msg_offplatform_confirm_title: 'You are sharing contact details',
    msg_offplatform_confirm_body: 'We cannot see or check what happens outside ThaiHelper, and this is how scams start. You can keep talking here instead.',
    msg_offplatform_confirm_send: 'Send anyway',
    msg_offplatform_confirm_cancel: 'Keep it in the chat',
  ...
  th: {
    ...
    hero_status_free: 'ฟรี',
    hero_unread: 'ยังไม่ได้อ่าน',
    launch_banner_title: 'ฟรีสำหรับทุกคน',
    launch_banner_text: 'ThaiHelper ใช้งานฟรี 100% สำหรับครอบครัวและผู้ช่วย เข้าถึงเต็มรูปแบบรวมถึงการส่งข้อความไม่จำกัด ไม่มีค่าใช้จ่าย',
    logout: 'ออกจากระบบ',
    ...
    msg_offplatform_title: 'คุณกำลังจะออกจาก ThaiHelper',
    msg_offplatform_body: 'เราไม่สามารถตรวจสอบสิ่งที่เกิดขึ้นนอกแอปได้ และมิจฉาชีพมักใช้ช่องทางนี้ กรุณาพูดคุยเรื่องงานและข้อเสนองานในแชทนี้',
    msg_offplatform_confirm_title: 'คุณกำลังแชร์ข้อมูลติดต่อ',
    msg_offplatform_confirm_body: 'เราไม่สามารถตรวจสอบสิ่งที่เกิดขึ้นนอก ThaiHelper ได้ และมิจฉาชีพมักใช้ช่องทางนี้ คุณสามารถพูดคุยต่อที่นี่ได้เลย',
    msg_offplatform_confirm_send: 'ส่งต่อไป',
    msg_offplatform_confirm_cancel: 'คุยต่อในแชท',
