...
const ALL_FAQS = [
  ...
  { question: 'Can foreigners hire domestic helpers in Thailand?', answer: 'Yes, foreigners (expats) living in Thailand can legally hire domestic helpers. If you hire a Thai national, no work permit is needed for the helper. If you hire a helper from Myanmar, Laos or Cambodia, they need a valid work permit issued under Thailand\u2019s MOU system \u2014 the only route open to a private family for household work. For Filipino, Vietnamese, Indian and Western nationals no household work permit can be issued at all, because Thailand has no domestic-worker MOU with those countries and a household cannot sponsor a Non-Immigrant B visa. Driving is reserved for Thai nationals in every case. Our free Work Permit Wizard at thaihelper.app/work-permit-wizard checks a specific candidate in five questions.' },
  ...
  { question: 'How does ThaiHelper compare to Facebook groups for finding helpers?', answer: 'ThaiHelper offers email-verified profiles with structured information (experience, skills, languages, photos) and direct in-platform messaging — unlike Facebook groups which have no email verification, unstructured posts, and spam. ThaiHelper is purpose-built for finding household staff, while Facebook groups are general-purpose communities.' },
  { question: 'How does ThaiHelper compare to traditional agencies?', answer: 'Traditional agencies in Thailand typically charge 1-3 months salary as placement fees. ThaiHelper is free for both sides and connects families directly with staff — you can browse every registered helper in your city and message them directly.' },
  { question: 'Where can expats find trusted household help in Thailand?', answer: 'Expats in Thailand can find household help through ThaiHelper (thaihelper.app), which offers email-verified helper profiles across Bangkok, Chiang Mai, Phuket, Pattaya, Koh Samui, and Hua Hin. The interface is available in English and Thai, with helpers who speak many additional languages including Filipino, Russian, Burmese and Khmer.' },
