...
// MOU framework covers Myanmar, Laos, Cambodia AND Vietnam — every Thai
// Cabinet extension since 2025 names all four. Vietnam was missing here
// originally so Vietnamese helpers were wrongly routed to the more
// expensive Non-B track.
const MOU_NATIONALITIES = ['myanmar', 'laos', 'cambodia', 'vietnam'];
