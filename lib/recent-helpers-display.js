...
export const FALLBACK_HELPERS = [
  ...
  { firstName: 'Niran',   lastInitial: 'P.', category: 'driver',      city: 'bangkok',    photo: null,                                                                                            timeLabel: { en: '3d ago',    th: '3 วันที่แล้ว' } },
  { firstName: 'Malai',   lastInitial: 'S.', category: 'tutor',       city: 'chiang_mai', photo: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=120&h=120&fit=crop&crop=face',  timeLabel: { en: '4d ago',    th: '4 วันที่แล้ว' } },
  { firstName: 'Wassana', lastInitial: 'K.', category: 'housekeeper', city: 'pattaya',    photo: null,                                                                                            timeLabel: { en: '5d ago',    th: '5 วันที่แล้ว' } },
  { firstName: 'Kanya',   lastInitial: 'R.', category: 'nanny',       city: 'koh_samui',  photo: null,                                                                                            timeLabel: { en: '1w ago',    th: '1 สัปดาห์ที่แล้ว' } },
];
