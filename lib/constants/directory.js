...
export const DIRECTORY_TYPES = [
  ...
  { value: 'training',    en: 'Training Provider',      th: 'ผู้ให้บริการฝึกอบรม' },
  { value: 'partner',     en: 'Service Partner',        th: 'พันธมิตรบริการ' },
  { value: 'association', en: 'Association / NGO',      th: 'สมาคม / NGO' },
];
