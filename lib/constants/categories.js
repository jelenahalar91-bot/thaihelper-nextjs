...
export const CATEGORIES_DATA = [
  ...
  {
    slug: 'petsitter',
    name: 'Pet Sitter & Dog Walker',
    name_th: 'ดูแลสัตว์เลี้ยง / พาสุนัขเดินเล่น',
    icon: '🐾',
    salary_range: { min: 8000, max: 20000 },
    description: 'Hire trusted pet sitters and dog walkers in Thailand. House visits, overnight stays, dog walking, cat care and pet boarding.',
    keywords: 'pet sitter Thailand, dog walker Bangkok, cat sitter Thailand, overnight pet sitting Phuket, pet boarding Thailand',
  },
];
...
export const SKILLS_BY_CATEGORY = {
  ...
  tutor: [
    ...
    { value: 'japanese_lang', en: 'Japanese language',               th: 'ภาษาญี่ปุ่น' },
  ...
  petsitter: [
    { value: 'dog_walking',    en: 'Dog walking',                     th: 'พาสุนัขเดินเล่น' },
    { value: 'cat_care',       en: 'Cat care & feeding',              th: 'ดูแลและให้อาหารแมว' },
    { value: 'house_visits',   en: 'Drop-in visits (feed & play)',    th: 'แวะดูแลที่บ้าน (ให้อาหาร / เล่น)' },
    { value: 'overnight_stay', en: 'Overnight stay at owner’s home', th: 'พักค้างคืนที่บ้านเจ้าของ' },
    { value: 'live_in_pet',    en: 'Live-in pet care (multi-day)',    th: 'อยู่ดูแลสัตว์เลี้ยงหลายวัน' },
    { value: 'pet_boarding',   en: 'Pet boarding at sitter’s home',  th: 'รับเลี้ยงที่บ้านผู้ดูแล' },
    { value: 'puppy_care',     en: 'Puppy care',                      th: 'ดูแลลูกสุนัข' },
    { value: 'senior_pets',    en: 'Senior or special-needs pets',    th: 'สัตว์เลี้ยงสูงวัย / ต้องดูแลพิเศษ' },
    { value: 'medication_pet', en: 'Medication administration',       th: 'ให้ยาสัตว์เลี้ยง' },
    { value: 'bathing_pet',    en: 'Bathing & basic grooming',        th: 'อาบน้ำ / ตัดแต่งขนพื้นฐาน' },
    { value: 'pet_taxi',       en: 'Pet taxi / vet transport',        th: 'รับ-ส่งสัตว์เลี้ยง / พาไปหาสัตวแพทย์' },
    { value: 'multiple_pets',  en: 'Comfortable with multiple pets',  th: 'ดูแลสัตว์หลายตัวได้' },
    { value: 'exotic_pets',    en: 'Exotic pets (birds, reptiles)',   th: 'สัตว์เลี้ยงพิเศษ (นก / สัตว์เลื้อยคลาน)' },
  ],
  multiple: [
