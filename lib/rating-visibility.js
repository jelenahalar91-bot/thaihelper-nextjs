...
// the whole story.
//
// 2026-09-16 — back to 1. On 12.09. the rule for who may review at all was
// tightened far harder: three messages from each side, plus a day's wait
// (see MIN_MESSAGES_PER_SIDE in pages/api/ratings.js). Of 990 family-helper
// pairs on the platform, 130 clear that bar. The gate moved to the entrance,
// and keeping it at the exit as well cost more than it protected:
