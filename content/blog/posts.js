...
export const blogPosts = [
...

  {
    ...
    content_th: `
      ...
      <h2>ข้อกำหนดทางกฎหมาย — โปรดอ่านอย่างละเอียด</h2>
      <p>เราขอบอกคุณตรงๆ ดีกว่าปล่อยให้คุณเจอตำรวจตรวจคนเข้าเมืองก่อน ในฐานะคนต่างชาติคุณต้องมีใบอนุญาตทำงาน และสำหรับ<strong>งานในบ้าน</strong> — พี่เลี้ยง แม่บ้าน ผู้ดูแล พ่อครัวในบ้านส่วนตัว — ประเทศไทยออกใบอนุญาตเฉพาะภายใต้ MOU แรงงานกับพม่า ลาว และกัมพูชาเท่านั้น <strong>ไม่มี MOU กับฟิลิปปินส์</strong> ดังนั้นครอบครัวเอกชนไม่สามารถสนับสนุน WP สำหรับงานในบ้านให้คุณได้ ไม่ว่าจะเต็มใจแค่ไหนหรือใช้เอเจนต์คนไหนก็ตาม</p>
      <ul>
        <li>คุณไม่สามารถทำงานอย่างถูกกฎหมายด้วยวีซ่าท่องเที่ยว วีซ่ายกเว้น หรือวีซ่านักเรียน (ED) วีซ่ารันชายแดนก็ไม่ช่วยเช่นกัน</li>
        <li>เส้นทาง Non-Immigrant B ต้องมีนายจ้างเป็นบริษัทไทยจดทะเบียนที่มีทุนจดทะเบียนชำระแล้ว 2 ล้านบาทและพนักงานไทย 4 คนต่อการจ้างต่างชาติ 1 คน — ครอบครัวเอกชนไม่เข้าเกณฑ์</li>
        <li><strong>การสอนพิเศษและการเป็นครู</strong>เป็นหมวดหมู่ที่มีเส้นทางถูกกฎหมายสำหรับคนฟิลิปปินส์ — แต่ใบอนุญาตต้องออกให้กับนายจ้างเช่นโรงเรียน ศูนย์ภาษา หรือบริษัทติวเตอร์ ไม่ใช่ครอบครัวที่คุณสอนให้</li>
        <li>บางเอเจนซี่พี่เลี้ยง (Madawa, Ayasan, Care Nest) จัด Non-B WP ให้ในฐานะ "พี่เลี้ยง / นักดูแลเด็ก" ผ่านบริษัท — เส้นทางนี้มีอยู่แต่ <strong>เปราะบางทางกฎหมาย</strong> หากผู้ตรวจสอบพบว่าหน้าที่จริงเป็นงานบ้าน WP จะถูกเพิกถอน</li>
        <li><strong>การขับรถ</strong>สงวนสำหรับคนไทยโดยสิ้นเชิง ไม่มีใบอนุญาตใดครอบคลุมได้</li>
        <li>ครัวเรือนทูตเป็นข้อยกเว้นตามกฎหมายที่แท้จริง หากตำแหน่งอยู่กับสถานทูต ขอให้ยืนยันเป็นลายลักษณ์อักษร</li>
      </ul>
      <p>หากคุณทำงานโดยไม่มีใบอนุญาตที่ถูกต้องและถูกพบ ผลกระทบจะตกกับคุณหนักกว่าครอบครัว: ค่าปรับ 5,000–50,000 บาท เนรเทศ และห้ามขอ WP ใหม่ 2 ปี ตั้งแต่ 28 ส.ค. 2569 ระเบียบสำนักนายกฯ ว่าด้วยการเนรเทศเพิ่มการห้ามกลับเข้าประเทศอย่างเป็นทางการ การตรวจสอบทั่วประเทศเพิ่มขึ้นตั้งแต่ พ.ค. 2569</p>
      <p>อ่าน<a href="/blog/work-permits-foreign-helpers-thailand">คู่มือใบอนุญาตทำงานฉบับสมบูรณ์</a>สำหรับรายละเอียด</p>
